...
ZEN2HAN = (
    ("ァー", "ｧ-"), ("ィー", "ｨ-"), ("ゥー", "ｩ-"), ("ェー", "ｪ-"), ("ォー", "ｫ-"),
    ("ッー", "ｯ-"), ("ャー", "ｬ-"), ("ュー", "ｭ-"), ("ョー", "ｮ-"),
    ("ガー", "ｶﾞ-"), ("ギー", "ｷﾞ-"), ("グー", "ｸﾞ-"), ("ゲー", "ｹﾞ-"), ("ゴー", "ｺﾞ-"),
    ("ザー", "ｻﾞ-"), ("ジー", "ｼﾞ-"), ("ズー", "ｽﾞ-"), ("ゼー", "ｾﾞ-"), ("ゾー", "ｿﾞ-"),
    ("ダー", "ﾀﾞ-"), ("ヂー", "ﾁﾞ-"), ("ヅー", "ﾂﾞ-"), ("デー", "ﾃﾞ-"), ("ドー", "ﾄﾞ-"),
    ("バー", "ﾊﾞ-"), ("ビー", "ﾋﾞ-"), ("ブー", "ﾌﾞ-"), ("ベー", "ﾍﾞ-"), ("ボー", "ﾎﾞ-"),
    ("パー", "ﾊﾟ-"), ("ピー", "ﾋﾟ-"), ("プー", "ﾌﾟ-"), ("ペー", "ﾍﾟ-"), ("ポー", "ﾎﾟ-"),
    ("ヴー", "ｳﾞ-"),
    ("アー", "ｱ-"), ("イー", "ｲ-"), ("ウー", "ｳ-"), ("エー", "ｴ-"), ("オー", "ｵ-"),
    ("カー", "ｶ-"), ("キー", "ｷ-"), ("クー", "ｸ-"), ("ケー", "ｹ-"), ("コー", "ｺ-"),
    ("サー", "ｻ-"), ("シー", "ｼ-"), ("スー", "ｽ-"), ("セー", "ｾ-"), ("ソー", "ｿ-"),
    ("ター", "ﾀ-"), ("チー", "ﾁ-"), ("ツー", "ﾂ-"), ("テー", "ﾃ-"), ("トー", "ﾄ-"),
    ("ナー", "ﾅ-"), ("ニー", "ﾆ-"), ("ヌー", "ﾇ-"), ("ネー", "ﾈ-"), ("ノー", "ﾉ-"),
    ("ハー", "ﾊ-"), ("ヒー", "ﾋ-"), ("フー", "ﾌ-"), ("ヘー", "ﾍ-"), ("ホー", "ﾎ-"),
    ("マー", "ﾏ-"), ("ミー", "ﾐ-"), ("ムー", "ﾑ-"), ("メー", "ﾒ-"), ("モー", "ﾓ-"),
    ("ヤー", "ﾔ-"), ("ユー", "ﾕ-"), ("ヨー", "ﾖ-"),
    ("ラー", "ﾗ-"), ("リー", "ﾘ-"), ("ルー", "ﾙ-"), ("レー", "ﾚ-"), ("ロー", "ﾛ-"),
    ("ワー", "ﾜ-"), ("ヲー", "ｦ-"), ("ンー", "ﾝ-"),
